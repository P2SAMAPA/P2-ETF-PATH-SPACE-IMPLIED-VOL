...
OUTPUT_REPO = "P2SAMAPA/p2-etf-path-space-implied-vol-results"
...
# Path-space IV parameters
SIG_DEPTH = 4                # signature depth for path representation
HORIZON = 21                 # volatility horizon (days)
TOP_N = 3
